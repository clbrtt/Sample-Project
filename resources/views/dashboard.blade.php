...
<div class="main-content">
    <div class="dashboard">
        ...
        <form class="form-products" action="{{route('Sampleproducts')}}" method="post">
            ...
            <input type="prodname" name="prod_name" id="InputProdname" class="form-control" placeholder="Product Name"
                required="" autofocus="">
            <br>
        ...
        <a href="/login"><button type="button" action="{{route('Logout')}}" method="get"
